...
It enables us to estimate an age for any cool MS star with a measured rotation period and colour, along with an associated uncertainty that reflects both measurement errors and the intrinsic scatter in the gyrochronology relations.
Although we provide a newly calibrated gyrochronology relation that best describes the available data, we find that no single relation beween rotation period, colour and age can adequately describe all of the cluster data.
This may have worrying consequences for the reliability of gyrochronology as a dating method.
% Further investigation into the level of intrinsic scatter in the gyrochronology parameters will be required
