...
Until now it has only been calibrated using only young clusters, with the Sun
providing the only age dependence, and is therefore poorly calibrated at late
ages.
...
In particular, the Kepler asteroseismic stars and the local field stars
cannot both be described by the same gyrochronology relation.
The Kepler asteroseismic stars may be subject to observational biases, however
we also found that some clusters were not well described by a single
gyrochronology relation.
