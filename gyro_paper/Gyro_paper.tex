...
A function of the following form was fit to the data:
...
where n, a, b and c are all constants between 0 and 1 and take the values: 0.5189, 0.7725, 0.601 and 0.4 respectively in \citet{Barnes_2007}.

Fitting a model to the data is not straight-forward in this case as there are uncertainties on all three parameters: P, t and B-V.
Usual least-squares or maximum likelihood approaches only allow for errors on the independent variable.
