...
For those samples that fell in the cool dwarf regime ($B-V$ $>$ 0.45 and \logg$~>$ \subcut), a model rotation period was calculated using equation \ref{eq:Barnes2007_2} and a likelihood calculated using a Gaussian mixture model likelihood function.
