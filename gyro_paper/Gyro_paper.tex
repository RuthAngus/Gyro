...
% a 4.007349014282226562e-01 3.385353118181222420e-01 4.941277205944061279e-02
% n 5.532439947128295898e-01 2.186138391494751865e-02 9.347639799118040438e-02
% b 3.076129555702209473e-01 4.958939552307128906e-02 2.219268679618835449e-02
...
Some if the most likely are:
the asteroseismic ages or the photometric rotation periods could be
systematically biased; the rotation periods might be subject to Malmquist bias
due to incomplete detection; the different populations have different physical
properties (e.g. metallicity), not accounted for in the gyrochronology model.
...
It was the careful and well motivated modelling techniques used in this work
which allowed us to identify the potential shortcomings of the current
gyrochronology model.
Only by conducting MCMC parameter exploration and studying the resulting
posterior PDFs were we able to identify that different subsets of our data
sample preferred different model parameters.
...
This tells us the physical model is probably not good enough, but it - or
...
% is concerning for the reliability of gyrochronology.
% : perhaps it should
