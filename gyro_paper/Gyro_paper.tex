...
SKF cross validation is useful when the data is made up of different populations: instead of randomly drawing test and train data from the entire data set, a consistent percentage of stars is drawn from each population.
