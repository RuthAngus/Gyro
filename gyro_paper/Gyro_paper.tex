...
Figures \ref{fig:650} - \ref{fig:13gyr} show the new gyrochronology relation in period-colour space at a sequence of ages.
The shaded regions show the 16th and 84th percentile uncertainties of the new relation.
...
Figure \ref{fig:p_vs_bv_solar} shows rotation period vs colour for stars with age within 2 $\sigma$ of the Sun's: 4.568 Gyr.
Figure \ref{fig:p_vs_a_solar} shows rotation period vs age for stars with B-V colour within 1 $\sigma$ of the Sun's: 0.65.
...
\begin{center}
    ...
    \end{center}
    \caption{ \prot vs B-V colour for stars within 1$\sigma$ of the reference age with the new gyrochronology relation and \citet{Barnes2007}, and \citet{Mamajek2008} for comparison. Asteroseismic targets are circles and cluster and field stars are red triangles. The shaded region represents the 16th and 84th percentile uncertainties.
     }
...
\caption{Rotation period vs B-V colour for cool dwarfs with age within 2$\sigma$ of the Sun's age, 4.568 Gyr. The grey stars are hotter than 6250 K. The Sun is shown as a large grey circle.}
...
\caption{Rotation period vs age for cool dwarfs with colour within 2$\sigma$ of the Sun's: 0.65, with gyrochronology relations of \citet{Barnes2007}, \citet{Mamajek2008} and this work. The shaded region represents the 16th and 84th percentile uncertainties. The Sun is shown as a large grey circle.}
...
We would like to thank Eric Mamajek, Marc Pinsonneault, Sydney Barnes, Steve Kawaler, Jerome Bouvier, Daniel Mortlock and David Hogg for their useful insight and discussion.
