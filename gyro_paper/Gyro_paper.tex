...
and rotation periods were successfully measured for 144 of the 505. 
These 144 were divided into MS and sub-giant stars based on their logg values presented in Chaplin et al (2013). Stars with logg $>$ 4.0 were classified as MS stars and those with logg $<$ 4.0 as sub-giants. 
...
The isomass lines of the Barnes (2007) and Mamajek and Hillenbrand (2008) gyrochronology relations appear to adequately describe the slope of the observed period-age relation, but not the y-axis offset. 
These existing gyrochronology relations are not consistent with the observed dependence of period on mass for low-mass stars.  


\begin{figure}[ht]
\begin{center}
\includegraphics[width=6in, clip=true, trim=0 0 0.5in 0]{/Users/angusr/Python/Gyro/p_vs_a6.png}
\caption{Rotation period vs asteroseismic age for 59 MS stars. The colour scale shows mass. Isomass lines of the Barnes (2007) and Mamajek and Hillenbrand (2008) gyrochronology relations are shown for different masses as solid and dashed lines respectively.}
\label{fig:results}
\end{center}
\end{figure}
...
Ask Amy to send her latest version of her code (and automated version?)
