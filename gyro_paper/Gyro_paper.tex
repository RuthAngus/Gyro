...
We find $a = \gyroa^{+\aerrp}_{_aerrm}$, $b = \gyrob^{+berrp}_{-berrm}$ and
$n = \gyron^{+nerrp}_{-nerrm}$.
...
extrememly useful.
Gyrochronology is a dating method that utilises the
(theoretically)  % referee
...
was inconsistent at greater than 2$\sigma$.  % referee
...
uncertainty of
$\pm 0.01$ % referee
mag to each colour measurement.
