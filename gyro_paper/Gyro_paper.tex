...
\startdata
Praesepe & 0.588 $\pm$ 0.137 & 1 & 2 \\
Hyades & 0.625 $\pm$ 0.05 & 3 & 4 \\
NGC 6811 & 1.1 $\pm$ 0.2 & 5 & 6 \\
M 34 & \\
Coma Ber & \\
Pleides & \\
\enddata
\tablecaption{References: (3) \citet{Perryman1998}, (4) \citet{Radick1987}, (5) \citet{Janes2011}, (6) \citet{Meibom2011}, (1) \citet{Khalaj2013}, (2) \citet{Kovacs2014}. NGC 6811 g-r colours were converted to dereddened B-V with $E_{(B-V)}$ = 0.1. B and V colours for Praesepe were taken from the APASS database (http://www.aavso.org/apass).}
\end{deluxetable}
