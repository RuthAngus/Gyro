...
Ages derived from individual oscillation mode measurements can have uncertainties as small as 10\% (\citet{Brown1994}, \citet{SilvaAguirre2013}, however the process of measuring frequencies for individual oscillation modes is a manual, more time consuming process and can only be applied in the highest signal-to-noise cases.
...
An autocorrelation function describes the self-similarity of a light curve at a range of lag times and the highest peak in the ACF (usually also the first peak) is centered on the dominant periodic signal in the time series.
