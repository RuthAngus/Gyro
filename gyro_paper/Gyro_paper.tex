...
% Infra-Red Flux Method (IRFM) calibration (Casagrande et al. 2010; see also Silva Aguirre et al. 2012). This made use of multi-band JHK photometry from the Two Micron All Sky Survey (2MASS; Skrutskie et al. 2006), photometry in the SDSS griz bands available in the KIC, and reddening estimates from Drimmel et al. (2003). A second set of temperatures were those derived by Pinsonneault et al. (2012), who performed a recalibration of the KIC photometry in the SDSS griz filters, using YREC models. The complementary photometry that was available to us did not allow strong constraints to be placed on the metallicity of all the targets. When using the photometric Teø in the grid searches we therefore adopted an [Fe/H] corresponding to an average value for the field of  0.2±0.3 dex (e.g. see Silva Aguirre et al. 2011).
...
Attempts to unite theory and observation are currently being conducted by ....
...
% List of figures:
% 3d plot of astero targets
% 3d plot of all data
% marginalised plot
% logg (or delta nu) vs teff with ASTEC model ischrones?
% plot of p vs bv for all stars with new or old isochrones?
% plot of p vs T for all stars
% plot of p vs a for all stars
% plot of a vs bv for all stars
% completeness plot?
% additional examples of ACF
