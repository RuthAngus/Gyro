...
It seems as though, adding the subgiants in (might not be the subgiants) is producing this strange trend - period decreasing with temperture decreasing.
Is this because, as temperature decreases, age increases and therefore period decreases?
Ie, does the MS turn-off trend bite us in the bum right now?
How can we get around this?

I'm wondering whether the fact that the b parameter (the power of the temperature dependence) is going to small values because of bias in our sample.
There is obviously a trend between age and temperature in our sample due to MS turn off age. This trend might dominate over the gyrochronology age-teff relation. Presumably no one has really had to take it into account before because nobody has used such old stars for calibration.
I think we might need to adapt the gyrochronology relation to take this into account, what do you think?
On the other hand, including MS turn-off in our model might mean that the gyro relation will depend on logg and metallicity.

For now I have tried removing stars with logg < 4.1 and teff > $6400$ in the hope that this will remove the problem.
It may well be worth running code on the Hyades to see what happens!

Future:
Still need to figure out why the rotation period errorbars make everything crash!
Is it because they are, like, an order of magnitude to small?
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=6in, clip=true, trim=0 0 0.5in 0]{/Users/angusr/Python/noisy-plane/fixie_pd.png}
