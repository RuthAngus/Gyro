...
% gyrochronology as a dating method: values of $a$, $b$ and $n$ measured for the
% Hyades and Coma Berenices were not consistent within uncertainties (see table
% \ref{tab:cluster_results}) and Praesepe and NGC 6811 were so discrepant that
% they could not be included in the final sample.
% It follows that a different relation might be required for every field star.
