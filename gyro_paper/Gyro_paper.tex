...
% comment on uncertainties added to cluster values
% check dereddened praesepe
% check dereddened NGC 6811
% rapidly rotating sample
...
% Uncertainties on colour made up
% Our results are not particularly sensitive to the choice of c

% check the population of outliers
% uncertainties - fisher something
...
\begin{figure}[ht]
\begin{center}
	\subfigure[Coma Berenices and field stars with Solar and cluster age isochrones with $c=0.45$.]{
            \label{fig:CF45}
...
\startdata
\hline
  \multicolumn{3}{|c|}{Test data = all remaining} \\
\hline
C \& F & P, H, N, A & 10.367 \\
P \& F & C, H, N, A & 13.159 \\
H \& F & C, P, N, A & 10.355 \\
N \& F & C, P, H, A & 11.870 \\
\hline
  \multicolumn{3}{|c|}{Test data = asteroseismic stars only} \\
\hline
C \& F & A & 15.221 \\
P \& F & A & 16.291 \\
H \& F & A & 15.379 \\
N \& F & A & 16.512 \\
\hline
  \multicolumn{3}{|c|}{Hyades and Coma Ber only} \\
\hline
H \& F & A \& C & 14.672 \\
C \& F & A \& H & 14.309 \\
\hline
\multicolumn{3}{|c|}{SKF with all data} \\
\hline
1 & 2, 3, 4 \& 5 & 12.227 \\
2 & 1, 3, 4 \& 5 & 10.051 \\
3 & 1, 2, 4 \& 5 & 7.396 \\
...
5 & 1, 2, 3 \& 4 & 9.381 \\
\hline
\multicolumn{3}{|c|}{SKF with Hyades and Coma Ber only} \\
\hline
1 & 2, 3, 4 \& 5 & 12.246 \\
2 & 1, 3, 4 \& 5 & 15.458 \\
3 & 1, 2, 4 \& 5 & 16.988 \\
...
\label{eq:Barnes2007_2}
\end{equation}
% a $0.273~^{+0.02}_{-0.007}$
% b $0.409~^{+0.003}_{-0.03}$
% c $0.45$
% n $0.620~\pm 0.004$
