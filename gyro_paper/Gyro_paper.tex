...
% \feh$~$measurements), given the model parameters, $\hat{\mathbf{w}}_n$.
...
\colhead{Literature age (Gyr)}&
	...
	\colhead{Age 3 (Gyr)}}
\startdata
18 Sco      & $3.7 \pm 0.2$     & $3.9^{+0.3}_{-0.2}$ & $3.5^{+0.6}_{-0.5}$ &
$3.7^{+0.8}_{-0.6}$ \\
...
% 6.0
% my age: [ 5.02964382  1.03863637  0.77264253]
% my age2: [ 4.97316912  2.12116692  1.42827355]
% Barnes age: [ 4.46883898  1.05478568  0.87496929]
% M&H age: [ 4.73712945  1.21305857  0.96961086]
% minimum uncertainty [ 4.91011518  0.19499649  0.13067185]
% 172-30-7-159:noisy-plane angusr$ python field_star_predictions.py
% 0
% 6.0
% my age: [ 5.03142754  1.03375806  0.77531631]
% my age2: [ 4.97584651  2.12045528  1.42840272]
% Barnes age: [ 4.46799629  1.05834245  0.87246332]
% M&H age: [ 4.73856311  1.21581176  0.97151845]
% 1
% 6.0
% my age: [ 5.75707843  1.75003579  1.27963271]
% my age2: [ 5.69343132  2.68059324  1.79009105]
% Barnes age: [ 4.20207447  1.28439388  1.05443529]
% M&H age: [ 5.24039794  1.62090089  1.30011228]
% 2
% 3.66
% my age: [ 3.80842103  0.29895223  0.21661787]
% my age2: [ 3.80784969  1.44733466  0.99483114]
% Barnes age: [ 3.52559614  0.55963209  0.47130381]
% M&H age: [ 3.70359698  0.74772614  0.60699228]
% 3
% 6.4
% field_star_predictions.py:12: RuntimeWarning: invalid value encountered in log10
%   return 10**((np.log10(p) - np.log10(par[:, 0]) - \
% my age: [ 3.85396296  2.5988984   1.87216035]
% my age2: [ 3.66504551  2.90082893  1.85184665]
% Barnes age: [ 3.34342684  2.44823079  1.74445698]
% M&H age: [ 3.5535197   2.42572103  1.75889378]
% 4
% 4.568
% my age: [ 4.92692114  0.29596378  0.20990613]
% my age2: [ 4.94750321  1.90361943  1.30291399]
% Barnes age: [ 4.66920855  0.71349101  0.60549054]
% M&H age: [ 4.80902204  0.95679512  0.76809745]
% minimum uncertainty [ 4.91011518  0.19499649  0.13067185]
...
\begin{deluxetable}{lcccc}
\tablewidth{0pc}
\tablecaption{Clusters and References: (1) \citet{Dobbie2009}, (2)
	\citet{CollierCameron2009}, (3) \citet{Perryman1998}, (4)
	\citet{Radick1987}.
\label{tab:clusters}}
\tablehead{
\colhead{Cluster}&
...
% my age2: [ 4.93905861  1.99822206  1.37248796]
% Barnes age: [ 4.47032643  1.05352656  0.87347399]
% M&H age: [ 4.73870506  1.2168875   0.97319033]
% 1
% 6.0
% my age: [ 5.55213363  1.35991813  1.19307143]
% my age2: [ 5.61843434  2.59960772  1.74721257]
% Barnes age: [ 4.20182172  1.27971226  1.05450293]
% M&H age: [ 5.23659245  1.61806178  1.29991151]
% 2
% 3.66
% my age: [ 5.05915859  1.57535277  1.30555195]
% loo_results.py:12: RuntimeWarning: invalid value encountered in log10
%   return 10**((np.log10(p) - np.log10(par[:, 0]) - \
% my age2: [  5.59610189  27.16297183   4.01542638]
% Barnes age: [ 3.526096    0.56154019  0.47258962]
% M&H age: [ 3.70272578  0.75100695  0.60533324]
% 3
% 6.4
% my age: [ 3.7254493   2.25402795  1.77250786]
% my age2: [ 3.67211784  2.81575002  1.83724408]
% Barnes age: [ 3.33710689  2.44645431  1.74031474]
% M&H age: [ 3.55353478  2.41861574  1.7548924 ]
% 4
% 4.568
% my age: [ 5.72053402  1.10938536  0.52350016]
% my age2: [ 5.86557046  6.71676922  2.81084819]
% Barnes age: [ 4.66716328  0.71744527  0.60392631]
% M&H age: [ 4.81078899  0.95140657  0.76967131]
% minimum uncertainty [ 5.7077088   1.08930736  0.4885278 ]
