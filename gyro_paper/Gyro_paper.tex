...
The wings of the new relation show the 16th and 84th percentile uncertainties.
...
\begin{center}
    ...
    \end{center}
    \caption{ \prot vs B-V colour for stars within 1$\sigma$ of the reference age with the new gyrochronology relation and \citet{Barnes2007}, and \citet{Mamajek2008} for comparison. Asteroseismic targets are circles and cluster and field stars are triangles. The shaded region represents the 16th and 84th percentile uncertainties. {\color{red}These plots still need some tweaking!}
     }
...
\caption{Rotation period vs age for cool dwarfs with colour within 2$\sigma$ of the Sun's; 0.65. The Sun is shown as a large grey circle.}
